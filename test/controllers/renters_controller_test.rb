...
class RentersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create renter" do
    assert_difference('Renter.count') do
      post renters_url, params: { renter: { address: @renter.address, citizenship: @renter.citizenship, id_number: @renter.id_number, name: @renter.name, phone: @renter.phone, sex: @renter.sex } }
    end
  ...
  test "should update renter" do
    patch renter_url(@renter), params: { renter: { address: @renter.address, citizenship: @renter.citizenship, id_number: @renter.id_number, name: @renter.name, phone: @renter.phone, sex: @renter.sex } }
